...
public class DBConstants {
    ...
    //Requete selectionnant toutes les lignes de la table ticket qui correspondent au numéro d'immatriculation
    public static final String GET_NB_TICKETS = "select OUT_TIME from ticket where VEHICLE_REG_NUMBER=?";
